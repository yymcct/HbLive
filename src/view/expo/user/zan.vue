<template>
  ...
  <div class="wapper">
    ...
    <div>
      ...
      >
        <div class="con" v-for="(item, index) in zan" :key="index">
          <div class="con-r">
...
import { api_GetMemberThumbsUp } from "@/api/meetingApi";
export default {
  name: "Zan",
  props: [""],
  data() {
  ...
  methods: {
    ...
    getZan() {
      api_GetMemberThumbsUp({
        ...
        this.zan = this.zan.concat(res.result); 
      });
    },
    setScrollHeight() {
      this.scrollHeight =
